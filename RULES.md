...
- Правил: ~80 · Тестов: 182/182 · Движок: .NET 5
...
- `if`: первое условие — на строке `if`, остальные с табом, тело — на следующей строке на уровне `if` (см. `if`);
...
### `if` — IF / ELSE: первое условие на строке `if`, тело на следующей строке
