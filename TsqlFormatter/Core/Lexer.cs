...
public sealed class Lexer
{
    private static readonly HashSet<string> SqlKeywords = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        "CREATE","ALTER","DROP","TABLE","VIEW","INDEX","PROCEDURE","FUNCTION","ASSEMBLY",
        "BEGIN","END","IF","ELSE","WHILE","RETURN","RETURNS","EXEC","EXECUTE",
        "CONTINUE","BREAK","GOTO","WAITFOR",
        ...
        "IDENTITY_INSERT",
        "PRIMARY","FOREIGN","KEY","CONSTRAINT","DEFAULT","IDENTITY","CHECK","REFERENCES",
        "NONCLUSTERED","CLUSTERED","UNIQUE","INCLUDE","FILLFACTOR","PAD_INDEX","PERSISTED",
